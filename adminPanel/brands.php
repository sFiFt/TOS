...
<html>
    ...
    <body>	
		...
		if ($_SESSION['counter'] != 1){
			header ('Location: ../Controllers/brandsController.php');
		}
		...
		?>
			...
			<div id = "selection">
				...
				<div class="adminTitle" style = "margin-left:272px; width:250px"><h2>Добавить новый бренд</h2></div><br>
				
				<form class="adminForm" action = "../Controllers/brandsController.php" method = "POST" id = "formInsert">
					...
					<div class="adminFormTitle">Название бренда</div>
